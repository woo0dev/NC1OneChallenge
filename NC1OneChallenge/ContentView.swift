...
struct ContentView: View {
    ...
    @State var posts: [post] = [post(categoryName: "1일 1커밋", title: "4월 20일 기록", description: "알고리즘 풀이를 커밋했다.", image: Image("git")), post(categoryName: "손씻기", title: "4월 21일 기록", description: "4월 21일 12시에 손을 씻었다.", image: Image(systemName: "hands.sparkles"))]
    var body: some View {
